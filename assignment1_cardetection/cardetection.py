...
def yolo_filter_boxes(box_confidence, boxes, box_class_probs, threshold=.6):
    """
    Filter YOLO boundary boxes by thresholding on object class score.

    Arguments:
    box_confidence -- tensor of shape (19, 19, 5, 1) containing $p_c$ (confidence probability that there's some object)
...
def iou(box1, box2):
    ...
    # x1,y1 represents the left bottom end and x2, y2 represents the right upper cordinate
    # For intersection we will take maximum end points of both boxes then find length (x2-x1) and height(y2-y1)
